package com.example.findnewfriends.view;

/**
 * Thanks to Reza Shiftehfar, Sara Khosravinasr and Jorge Silva's 3d tag cloud code in github.
 */
...
import com.example.findnewfriends.model.TagCloud;
...
public class TagCloudView extends RelativeLayout {
    ...
    public TagCloudView(Context mContext, int width, int height, List<Tag> tagList, int offsetX, int offsetY) {
        // text size
        this(mContext, width, height, tagList, 30, 60, 1, offsetX, offsetY); // default
        // for
        // min/max
    }
